...
const Hero = () => {
    return (
        <div className='bg-white flex flex-col sm:mt-52'>
            <div className="flex flex-col lg:ml-52 lg:mb-4 md:ml-28 md:mb-2 sm:ml-28 sm:mb-2">
            ...
            text-3xl font-black ml-52'>
                VERNON
                <br />
                NEILLY
            </h1>
            <div className='flex flex-col lg:ml-60 lg:mt-10 md:mt-6 sm:mt-6 md:ml-32 sm:ml-28'>
